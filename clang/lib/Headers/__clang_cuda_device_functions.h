 ...
 */
 ...
 __DEVICE__ float __f16_half2float(unsigned short __a) {
   __half_union __u;
   __u.i = __a;
   return __nv_f16_half2float(__u.h);
 }
 
 __DEVICE__ float __f16_low2float(unsigned int __a) {
   __half2_union __u;
   __u.i = __a;
   return __nv_f16_low2float(__u.v);
 }
 
 __DEVICE__ float __f16_high2float(unsigned int __a) {
   __half2_union __u;
   __u.i = __a;
   return __nv_f16_high2float(__u.v);
 }
 
 __DEVICE__ char __f16_half2char_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2char_rz(__u.h);
 }
 
 __DEVICE__ unsigned char __f16_half2uchar_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2uchar_rz(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_half2short_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2short_rz(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_half2ushort_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2ushort_rz(__u.h);
 }
 
 __DEVICE__ unsigned int __f16_half2int_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2int_rz(__u.h);
 }
 
 __DEVICE__ unsigned int __f16_half2uint_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2uint_rz(__u.h);
 }
 
 __DEVICE__ long long __f16_half2ll_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2ll_rz(__u.h);
 }
 
 __DEVICE__ unsigned long long __f16_half2ull_rz(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2ull_rz(__u.h);
 }
 
 __DEVICE__ float2 __f16_half22float2(unsigned int __a) {
   __half2_union __u;
   __u.i = __a;
   return __nv_f16_half22float2(__u.v);
 }
 
 __DEVICE__ unsigned int __f16_half2int_rn(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2int_rn(__u.h);
 }
 
 __DEVICE__ unsigned int __f16_half2int_rd(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2int_rd(__u.h);
 }
 
 __DEVICE__ unsigned int __f16_half2int_ru(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2int_ru(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_int2half_rn(unsigned int __i) {
   __half_union __u;
   __u.h = __nv_f16_int2half_rn(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_int2half_rz(unsigned int __i) {
   __half_union __u;
   __u.h = __nv_f16_int2half_rz(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_int2half_rd(unsigned int __i) {
   __half_union __u;
   __u.h = __nv_f16_int2half_rd(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_int2half_ru(unsigned int __i) {
   __half_union __u;
   __u.h = __nv_f16_int2half_ru(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_half2short_rn(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2short_rn(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_half2short_rd(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2short_rd(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_half2short_ru(unsigned short __h) {
   __half_union __u;
   __u.i = __h;
   return __nv_f16_half2short_ru(__u.h);
 }
 
 __DEVICE__ unsigned short __f16_short2half_rn(unsigned short __i) {
   __half_union __u;
   __u.h = __nv_f16_short2half_rn(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_short2half_rz(unsigned short __i) {
   __half_union __u;
   __u.h = __nv_f16_short2half_rz(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_short2half_rd(unsigned short __i) {
   __half_union __u;
   __u.h = __nv_f16_short2half_rd(__i);
   return __u.i;
 }
 
 __DEVICE__ unsigned short __f16_short2half_ru(unsigned short __i) {
   __half_union __u;
   __u.h = __nv_f16_short2half_ru(__i);
   return __u.i;
 }
 ...
 __DEVICE__ unsigned short __f16_rint(unsigned short __x) {
   __half_union __ux, __ur;
   __ux.i = __x;
   __ur.h = __nv_f16_rint(__ux.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_trunc(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_trunc(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_floor(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_floor(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_rint(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_rint(__ux.v);
   return __ur.i;
 }
 
 // FP16 manipulation functions
 __DEVICE__ unsigned int __f16_lows2half2(unsigned int __a, unsigned int __b) {
   __half2_union __ua, __ub, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16_lows2half2(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16_highs2half2(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16_highs2half2(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_low2half(unsigned int __a) {
   ...
   __half_union __ur;
   __ua.i = __a;
   __ur.h = __nv_f16_low2half(__ua.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16_low2half2(unsigned int __a) {
   __half2_union __ua, __ur;
   __ua.i = __a;
   __ur.v = __nv_f16_low2half2(__ua.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16_high2half2(unsigned int __a) {
   __half2_union __ua, __ur;
   __ua.i = __a;
   __ur.v = __nv_f16_high2half2(__ua.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_high2half(unsigned int __a) {
   ...
   __half_union __ur;
   __ua.i = __a;
   __ur.h = __nv_f16_high2half(__ua.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16_halves2half2(unsigned short __a, unsigned short __b) {
   __half_union __ua, __ub;
   __half2_union __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16_halves2half2(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16_half2half2(unsigned short __a) {
   ...
   __half2_union __ur;
   __ua.i = __a;
   __ur.v = __nv_f16_half2half2(__ua.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16_lowhigh2highlow(unsigned int __a) {
   __half2_union __ua, __ur;
   __ua.i = __a;
   __ur.v = __nv_f16_lowhigh2highlow(__ua.v);
   return __ur.i;
 }
 
 // FP16 comparison and min/max functions
 __DEVICE__ unsigned short __f16_max(unsigned short __x, unsigned short __y) {
   __half_union __ux, __uy, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __ur.h = __nv_f16_max(__ux.h, __uy.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_min(unsigned short __x, unsigned short __y) {
   ...
   __ux.i = __x;
   __uy.i = __y;
   __ur.h = __nv_f16_min(__ux.h, __uy.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_max(unsigned int __x, unsigned int __y) {
   __half2_union __ux, __uy, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __ur.v = __nv_f16x2_max(__ux.v, __uy.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_min(unsigned int __x, unsigned int __y) {
   ...
   __ux.i = __x;
   __uy.i = __y;
   __ur.v = __nv_f16x2_min(__ux.v, __uy.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_eq(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_eq(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_ne(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_ne(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_le(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_le(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_ge(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_ge(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_lt(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_lt(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_gt(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_gt(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_equ(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_equ(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_neu(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_neu(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_leu(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_leu(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_geu(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_geu(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_ltu(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_ltu(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_gtu(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_gtu(__ua.v, __ub.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_eq_mask(unsigned int __a, unsigned int __b) {
   __half2_union __ua, __ub;
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_eq_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_ne_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_ne_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_le_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_le_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_ge_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_ge_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_lt_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_lt_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_gt_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_gt_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_equ_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_equ_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_neu_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_neu_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_leu_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_leu_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_geu_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_geu_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_ltu_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_ltu_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned int __f16x2_gtu_mask(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16x2_gtu_mask(__ua.v, __ub.v);
 }
 ...
 __DEVICE__ unsigned short __f16_eq(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_eq(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_ne(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_ne(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_le(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_le(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_ge(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_ge(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_lt(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_lt(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_gt(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_gt(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_equ(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_equ(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_neu(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_neu(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_leu(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_leu(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_geu(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_geu(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_ltu(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_ltu(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned short __f16_gtu(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   return __nv_f16_gtu(__ua.h, __ub.h);
 }
 ...
 __DEVICE__ unsigned int __f16x2_add(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_add(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_sub(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_sub(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_mul(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_mul(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_add_sat(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_add_sat(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_sub_sat(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_sub_sat(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_mul_sat(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_mul_sat(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_add_rn(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_add_rn(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_sub_rn(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_sub_rn(__ua.v, __ub.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_mul_rn(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_mul_rn(__ua.v, __ub.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_fma(unsigned int __a, unsigned int __b, unsigned int __c) {
   __half2_union __ua, __ub, __uc, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __uc.i = __c;
   __ur.v = __nv_f16x2_fma(__ua.v, __ub.v, __uc.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_fma_sat(unsigned int __a, unsigned int __b, unsigned int __c) {
   __half2_union __ua, __ub, __uc, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __uc.i = __c;
   __ur.v = __nv_f16x2_fma_sat(__ua.v, __ub.v, __uc.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_div(unsigned int __a, unsigned int __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.v = __nv_f16x2_div(__ua.v, __ub.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_add(unsigned short __a, unsigned short __b) {
   __half_union __ua, __ub, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_add(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_sub(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_sub(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_mul(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_mul(__ua.h, __ub.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_add_sat(unsigned short __a, unsigned short __b) {
   __half_union __ua, __ub, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_add_sat(__ua.h, __ub.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_sub_sat(unsigned short __a, unsigned short __b) {
   __half_union __ua, __ub, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_sub_sat(__ua.h, __ub.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_mul_sat(unsigned short __a, unsigned short __b) {
   __half_union __ua, __ub, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_mul_sat(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_add_rn(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_add_rn(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_sub_rn(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_sub_rn(__ua.h, __ub.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_mul_rn(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_mul_rn(__ua.h, __ub.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_fma(unsigned short __a, unsigned short __b, unsigned short __c) {
   __half_union __ua, __ub, __uc, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __uc.i = __c;
   __ur.h = __nv_f16_fma(__ua.h, __ub.h, __uc.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_div(unsigned short __a, unsigned short __b) {
   ...
   __ua.i = __a;
   __ub.i = __b;
   __ur.h = __nv_f16_div(__ua.h, __ub.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_fma_sat(unsigned short __a, unsigned short __b, unsigned short __c) {
   __half_union __ua, __ub, __uc, __ur;
   __ua.i = __a;
   __ub.i = __b;
   __uc.i = __c;
   __ur.h = __nv_f16_fma_sat(__ua.h, __ub.h, __uc.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_tanh_approx(unsigned short __x) {
   __half_union __ux, __ur;
   __ux.i = __x;
   __ur.h = __nv_f16_tanh_approx(__ux.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_tanh_approx(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_tanh_approx(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_exp10(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_exp10(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_log10(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_log10(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_rsqrt(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_rsqrt(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_isnan(unsigned int __x) {
   __half2_union __ux, __ur;
   __ux.i = __x;
   __ur.v = __nv_f16x2_isnan(__ux.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned short __f16_abs(unsigned short __x) {
   __half_union __ux, __ur;
   __ux.i = __x;
   __ur.h = __nv_f16_abs(__ux.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_max_nan(unsigned short __x, unsigned short __y) {
   __half_union __ux, __uy, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __ur.h = __nv_f16_max_nan(__ux.h, __uy.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_min_nan(unsigned short __x, unsigned short __y) {
   __half_union __ux, __uy, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __ur.h = __nv_f16_min_nan(__ux.h, __uy.h);
   return __ur.i;
 }
 
 __DEVICE__ unsigned short __f16_fma_relu(unsigned short __x, unsigned short __y, unsigned short __z) {
   __half_union __ux, __uy, __uz, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __uz.i = __z;
   __ur.h = __nv_f16_fma_relu(__ux.h, __uy.h, __uz.h);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_max_nan(unsigned int __x, unsigned int __y) {
   ...
   __ux.i = __x;
   __uy.i = __y;
   __ur.v = __nv_f16x2_max_nan(__ux.v, __uy.v);
   return __ur.i;
 }
 ...
 __DEVICE__ unsigned int __f16x2_min_nan(unsigned int __x, unsigned int __y) {
   ...
   __ux.i = __x;
   __uy.i = __y;
   __ur.v = __nv_f16x2_min_nan(__ux.v, __uy.v);
   return __ur.i;
 }
 
 __DEVICE__ unsigned int __f16x2_fma_relu(unsigned int __x, unsigned int __y, unsigned int __z) {
   __half2_union __ux, __uy, __uz, __ur;
   __ux.i = __x;
   __uy.i = __y;
   __uz.i = __z;
   __ur.v = __nv_f16x2_fma_relu(__ux.v, __uy.v, __uz.v);
   return __ur.i;
 }
